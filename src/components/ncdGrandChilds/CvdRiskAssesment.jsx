...
function CvdRiskAssesment() {
  ...
  <div class="tab-content" id="v-pills-tabContent">
    <div class="tab-pane fade show active" id={val[0].nid} role="tabpanel" aria-labelledby={val[0].title} tabindex="0" >{Parser().parse(val[0].body)}</div>
   <div class="tab-pane fade" id={val[1].nid} role="tabpanel" aria-labelledby={val[1].title} tabindex="0">{`${val[1].assess_title}${val[1].assess_desc}${val[2].assess_title}${val[2].assess_desc}`}</div>
    <div class="tab-pane fade" id={val[3].nid} role="tabpanel" aria-labelledby={val[3].title} tabindex="0">{Parser().parse(val[3].body)}</div>
    <div class="tab-pane fade" id={val[4].nid} role="tabpanel" aria-labelledby={val[4].title} tabindex="0">
      {val[4].assess_title}<br/><img style={{width:"30%", height:"40%"}} src={val[4].assess_img} class="img-thumbnail" alt={val[4].assess_title}/><br/><br/>
    ...
    <div class="tab-pane fade" id={val[8].nid} role="tabpanel" aria-labelledby={val[8].title} tabindex="0">{Parser().parse(val[8].body)}</div>
    <div class="tab-pane fade" id={val[9].nid} role="tabpanel" aria-labelledby={val[9].title} tabindex="0">{Parser().parse(val[9].body)}</div>
    <div class="tab-pane fade" id={val[10].nid} role="tabpanel" aria-labelledby={val[10].title} tabindex="0">{Parser().parse(val[10].body)}</div>
  </div>
